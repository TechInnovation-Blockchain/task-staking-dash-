...
import { resetWalletConnector } from "contexts/UserContext";
  ...
  return (
    ...
    >
      <div className="modal-body p-0">
        <div
          className="container-wallet text-center p-4 grey-border-bottom"
        ...
        >
          <img
            ...
            alt="MetaMask"
          />
          <Typography weight={600} color="white" size={20}>
            Metamask
          </Typography>
          <Typography weight={400} color="textGrey" size={14}>
